...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .sidebar-brand-logo { display: flex; align-items: center; justify-content: center; margin-bottom: 1rem; }
        .sidebar-brand-logo img { width: 80px; height: 80px; object-fit: contain; background: white; padding: 10px; border-radius: 50%; box-shadow: var(--shadow-medium); }
        .sidebar-brand h2 { color:#fff; font-size:1.7rem; font-weight:800; text-align: center; }
        .sidebar-brand p { color: rgba(255,255,255,.9); margin:.5rem 0 0; font-size:.9rem; text-align: center; }
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            <div class="sidebar-brand-logo">
                <img src="{{ asset('images/logo-bank-mini.png') }}" alt="Bank Mini Tsamaniyah" style="width: 80px; height: auto; margin-bottom: 10px;">
            </div>
            <h2>Bank Mini Tsamaniyah</h2>
            <p>Teller Dashboard</p>
        </div>
    ...
    <div class="main-content">
        ...
        <div id="section-nasabah" class="content-section">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <form method="GET" action="{{ route('teller.dashboard') }}#nasabah" class="search-form">
                        <input type="hidden" name="section" value="nasabah">
                        ...
                        @if(request('search'))
                            <a href="{{ route('teller.dashboard') }}#nasabah" class="btn btn-secondary">
                        ...
                        <table class="table">
                            ...
                            @forelse($nasabahs as $n)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-secondary">{{ $n->nasabah->nis_nip ?? '-' }}</span>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                        ...
                        <table class="table">
                            ...
                            @forelse($pending as $p)
                                <tr>
                                    ...
                                    <form method="POST" action="{{ route('teller.transaksi.reject', $p->id) }}" class="d-inline"
    ...
    <script>
        ...
        function exportToPDF(type) {
            ...
            let title = 'LAPORAN KEUANGAN BANK MINI';
            doc.setFontSize(16);
        ...
        function exportToCSV(type) {
            let csvContent = '';
            let filename = 'Laporan_Keuangan_Bank_Mini';
        ...
        // ======= Auto-navigate to nasabah section if search parameter exists =======
        (function checkSearchParam() {
            const urlParams = new URLSearchParams(window.location.search);
            const searchParam = urlParams.get('search');
            const sectionParam = urlParams.get('section');
            
            if (searchParam || sectionParam === 'nasabah') {
                setTimeout(() => {
                    if (window.showSection) {
                        window.showSection('nasabah');
                    }
                }, 100);
            }
        })();
